...
import com.panabuntu.weathertracker.core.presentation.navigation.NavRoutesMain.Companion.RESULT_DEFAULT_KEY
...
interface NavRoutesMain {
    ...
    fun <T : Route> popBackStack(route: KClass<in T>, inclusive: Boolean = false)
