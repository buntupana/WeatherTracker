...
import com.panabuntu.weathertracker.feature.forecast_daily.presentation.forecast_day_list.ForecastDayListRoute
            ...
            AppTheme {
                Scaffold(
                    ...
                    NavHost(
                        ...
                        startDestination = ForecastDayListRoute
                    ) {
                        composable<ForecastDayListRoute> {
